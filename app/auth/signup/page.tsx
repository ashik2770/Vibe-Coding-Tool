...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { data, error } = await signUp(formData.email, formData.password, formData.name, referralCode || undefined);
      ...
      >
        <div className="card">
          <div className="text-center mb-8">
            <div className="w-12 h-12 bg-gradient-to-r from-primary-600 to-purple-600 rounded-lg flex items-center justify-center mx-auto mb-4">
